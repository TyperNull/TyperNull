  ...
  return (
    <section className="relative pt-12 pb-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        {/* Retro Font Title */}
        <div className="mb-12 py-8 overflow-hidden">
          <h1 className="section-header text-[10vw] sm:text-7xl md:text-8xl lg:text-9xl mb-4 animate-[pulse_3s_ease-in-out_infinite] leading-none px-2">
            TYPERNULL
          </h1>
        </div>
